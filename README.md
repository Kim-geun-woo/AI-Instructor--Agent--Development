...
저는 이 프로젝트에서 학습자의 능동적인 학습 경험을 위한 **①복습 퀴즈 생성(`Make_quiz`)** 로직 개발과, LLM이 강의 흐름을 더 잘 이해하도록 돕는 **②강의 스크립트 생성 고도화** 작업에 일부 참여했습니다.
...
https://flawless-paste-002.notion.site/_AI05-_09-2a69f09c2e59805187d8c8398d71b5a3
